    ...
    return (
        <nav className="sm:flex sm:justify-between p-5 lg:px-15">
            <div className="flex justify-between grow basis-0">
                ...
                <div>
                    <button 
                        type="button" className="sm:hidden text-gray-800 dark:text-gray-300 hover:text-black focus:text-black dark:hover:text-white dark:focus:text-white hover:cursor-pointer" 
                        onClick={toggleOpen}
