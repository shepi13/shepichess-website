        ...
        <nav className="sm:flex sm:justify-between p-5 lg:px-15">
            <div className="flex justify-between grow basis-0">
                <div className="h-14 md:h-20">
                    <Link href="/">
                        <Image alt="shepichess" src="/logo.svg" width={422} height={117} className="h-full w-auto" />
                    </Link>
                </div>
                <div>
                    <button type="button" className="sm:hidden text-gray-800 dark:text-gray-300 hover:text-black focus:text-black dark:hover:text-white dark:focus:text-white hover:cursor-pointer" onClick={toggleOpen}>
